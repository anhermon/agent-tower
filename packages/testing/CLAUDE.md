...
## Responsibility
- Shared test fixtures for the control plane. Currently exposes `./fixtures/core` only.
...
## Read First
- `package.json` — see the `exports` map; the entry point is `./fixtures/core/index.ts`.
